...
hilo2 = threading.Thread(target=cuenta2.transferir, args=(cuenta2, 100))
...
print(f"Saldo cuenta1: {cuenta2.saldo}")

#Explicación:
#Usamos RLock para evitar que multiples operaciones simultáneas en una cuenta causen bloqueos